...
let loader = new GLTFLoader().setPath('./model/');
    ...
    function init() {
        ...
        camera.position.set(80, 110, 140);
    ...
    function modelloader() {
        ...
        loader.load('library05.glb', function (gltf) {
        ...
        loader.load('tree03.glb', function (gltf) {
            ...
            const pos = [
                ...
                [-51, -2.5, 67], [-65, -3, 76], [-80.5, -1.5, 57],[-45,0,-3],
                [-37,0,-1],[-40,0,-6],[-42,0,1],[-16,-1.8,28.5]
            ]
